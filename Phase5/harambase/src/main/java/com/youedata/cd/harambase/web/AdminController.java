...
public class AdminController {
    ...
    public String login(HttpServletRequest request, HttpSession session) {
        ...
        if (adminService.login(uname, pwd) != null) {
            Admin admin = adminService.login(uname, pwd);
            session.setAttribute("admin", admin);
            return "WelcomeAdmin";
        } else if (memberService.login(uname, pwd) != null) {
    ...
    public String overallComm(HttpSession session) {
        List<Map<Integer, Overall>> overallComm = adminService.overallComm();
        Double total = adminService.total();
    ...
    public String salesReport(HttpSession session) {
        List<Map<Integer, Sales>> sales = adminService.sales();
    ...
    public String viewUsers(HttpSession session) {
        List<Map<Integer, Member>> memberMap = memberService.memberMap();
